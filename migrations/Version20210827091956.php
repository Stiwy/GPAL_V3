 ...
 */
final class Version20210827091956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE palette ADD CONSTRAINT FK_C7E5A77EE340FC6D FOREIGN KEY (logs_id) REFERENCES logs (id)');
